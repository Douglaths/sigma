    ...
    <script src="/sigma/Assets/js/jquery-3.7.0.min.js"></script>
    <script src="/sigma/Assets/js/bootstrap.min.js"></script>
    <script src="/sigma/Assets/js/main.js"></script>
      	...
      	series: [
      		{
      			...
      			radius: '100%',
      			data: [
      				{ value: 300, name: 'En progreso' },
      				{ value: 50, name: 'Demorado' },
      				{ value: 100, name: 'Completado' }
      			],
      			emphasis: {
      				itemStyle: {
      					shadowBlur: 10,
